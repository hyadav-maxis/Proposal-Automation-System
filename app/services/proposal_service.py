...
class ProposalService:
    ...
    def create_proposal(self, request: ProposalCreate) -> ProposalResponse:
        ...
        try:
            ...
            pricing = self._pricing.calculate_total_price(
                ...
                usa_based_resources=(request.resource_location == "usa_based"),
            )
            ...
            if request.resource_location == "usa_based" and pricing.get("usa_resources_surcharge"):
                sur = pricing["usa_resources_surcharge"]
                self._repo.insert_pricing_component(
                    proposal_id, "usa_resources_surcharge", "USA-Based Resources (+35%)",
                    1, sur, sur,
                )
    ...
    def get_proposal(self, proposal_id: int) -> Dict[str, Any]:
        ...
        _MAP = {
            ...
            "usa_resources_surcharge": "usa_resources_surcharge",
        }
        for c in components:
    ...
    def get_for_export(self, proposal_id: int) -> Optional[Dict[str, Any]]:
        ...
        subtotal = 0.0
        for c in components:
            if c["component_type"] != "usa_resources_surcharge":
